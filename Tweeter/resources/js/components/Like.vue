<template>
    <div>
        <template v-if="checkTweet()">
            <button @click="unlikeTweet" class="btn btn-outline-primary btn-sm mb-3">
                ...
                <!-- <span class="badge badge-pill badge-secondary">{{App\Tweet::find($tweet->id)->like->count()}}</span> -->
            </button>
        </template>

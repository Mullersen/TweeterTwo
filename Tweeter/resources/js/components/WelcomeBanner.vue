<template>
  <div id="welcome-banner">
      <div id="grid-wrapper" class="row align-items-center">
        <div class="col-6 bg-light-prime" style="height:90vh;">
        ...
        <div id="right" class="col-6 bg-light" style="height:90vh;">
            <h1 id="headerOne" class="ml-5" >Tweeter</h1>
        </div>
      </div>
  </div>
</template>
